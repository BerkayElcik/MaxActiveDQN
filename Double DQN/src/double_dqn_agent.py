import numpy as np
import torch as T
from double_deep_q_network import DeepQNetwork
...
class DoubleDQNAgent(object):
    ...
    def learn(self):
        ...
        q_prime = self.q_prime.forward(states_)
        ...
        #print("denme")
        #print(q_prime[indices, max_actions])

        q_target = rewards + self.gamma*q_prime[indices, max_actions]
